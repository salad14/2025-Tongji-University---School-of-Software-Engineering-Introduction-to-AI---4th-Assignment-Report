...
# --- 循环进行问答测试 ---
print(f"\n{'='*60}")
print(f"Starting ChatGLM3-6B Inference Tests with {len(test_questions)} questions.")
print(f"{'='*60}\n")
...
for i, prompt_text in enumerate(test_questions):
    ...
    print("-" * 30)
    print("ChatGLM3's Answer (Streaming Output):")

    model_inputs = tokenizer.build_chat_input(prompt_text, history=None).to(device)
...
print(f"\n{'='*60}")
print("All ChatGLM3-6B Inference Tests Completed!")
print(f"{'='*60}\n")